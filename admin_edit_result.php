    ...
    <div class="mainresultbody"> 
      <div class="container"> 
        <div class="submainresult"> 
          ...
          <a id='addresult' href='resultentry.php'>ADD NEW RESULT  </a><a id='addresult' href='admin_view_result_pri.php'>SEARCH RESULT HERE </a>
          <?php echo $errormsge1;?> 
                ...
                <table class="table table-striped table-bordered table-hover table-condensed"> 
                  ...
                  <tbody class=""> 
                    ...
                    <tr data-pg-collapsed> 
                      ...
                      <td> 
                        <input type="text" class="inputscore" name="phe_1" value="<?php echo $PHE_1;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="phe_2" value="<?php echo $PHE_2;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="phe_3" value="<?php echo $PHE_3;?>"> 
                      </td>
                      <td> 
                        <input type="text" class="inputscore" name="phe_e" value="<?php echo $PHE_E;?>"> 
                      </td>                       
                    </tr>                     
                    <tr data-pg-collapsed> 
                      <td class="subjects">COMPUTER STUDIES</td> 
                      <td> 
                        <input type="text" class="inputscore" name="comp_1" value="<?php echo $COMP_1;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="comp_2" value="<?php echo $COMP_2;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="comp_3" value="<?php echo $COMP_3;?>"> 
                      </td> 
                      <td> 
                        <input type="text" class="inputscore" name="comp_e" value="<?php echo $COMP_E;?>"> 
                      </td>                       
                    </tr>                     
                    <tr data-pg-collapsed> 
                      <td class="subjects">HOME ECONOMICS</td> 
                      <td> 
                        <input type="text" class="inputscore" name="he_1" value="<?php echo $HE_1;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="he_2" value="<?php echo $HE_2;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="he_3" value="<?php echo $HE_3;?>"> 
                      </td>
                       <td> 
                        <input type="text" class="inputscore" name="he_e" value="<?php echo $HE_E;?>"> 
                      </td>                       
                    </tr>                     
                    <tr data-pg-collapsed> 
                      <td class="subjects">FINE ARTS</td> 
                      <td> 
                        <input type="text" class="inputscore" name="fa_1" value="<?php echo $FA_1;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="fa_2" value="<?php echo $FA_2;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="fa_3" value="<?php echo $FA_3;?>"> 
                      </td>
                      <td> 
                        <input type="text" class="inputscore" name="fa_e" value="<?php echo $FA_E;?>"> 
                      </td>                       
                    </tr>                     
                    <tr data-pg-collapsed> 
                      <td class="subjects">AGRIC SCI</td> 
                      <td> 
                        <input type="text" class="inputscore" name="agr_1" value="<?php echo $AGR_1;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="agr_2" value="<?php echo $AGR_2;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="agr_3" value="<?php echo $AGR_3;?>"> 
                      </td> 
                      <td> 
                        <input type="text" class="inputscore" name="agr_e" value="<?php echo $AGR_E;?>"> 
                      </td>                       
                    </tr>                     
                    <tr data-pg-collapsed> 
                      <td class="subjects">VERBAL REASONING</td> 
                      <td> 
                        <input type="text" class="inputscore" name="vr_1" value="<?php echo $VR_1;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="vr_2" value="<?php echo $VR_2;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="vr_3" value="<?php echo $VR_3;?>"> 
                      </td>
                       <td> 
                        <input type="text" class="inputscore" name="vr_e" value="<?php echo $VR_E;?>"> 
                      </td>                       
                    </tr>                     
                    <tr data-pg-collapsed> 
                      <td class="subjects">Q. REASONING</td> 
                      <td> 
                        <input type="text" class="inputscore" name="qr_1" value="<?php echo $QR_1;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="qr_2" value="<?php echo $QR_2;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="qr_3" value="<?php echo $QR_3;?>"> 
                      </td> 
                      <td> 
                        <input type="text" class="inputscore" name="qr_e" value="<?php echo $QR_E;?>"> 
                      </td>                       
                    </tr>  
                    <tr data-pg-collapsed> 
                      <td class="subjects">PHONICS</td> 
                      <td> 
                        <input type="text" class="inputscore" name="fo_1" value="<?php echo $FO_1;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="fo_2" value="<?php echo $FO_2;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="fo_3" value="<?php echo $FO_3;?>"> 
                      </td> 
                      <td> 
                        <input type="text" class="inputscore" name="fo_e" value="<?php echo $FO_E;?>"> 
                      </td>                       
                    </tr> 
                    ...
                    <tr data-pg-collapsed> 
                      <td class="subjects">Q. REASONING</td> 
                      <td> 
                        <input type="text" class="inputscore" name="fr_1" value="<?php echo $FR_1;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="fr_2" value="<?php echo $FR_2;?>"> 
                      </td>                       
                      <td> 
                        <input type="text" class="inputscore" name="fr_3" value="<?php echo $FR_3;?>"> 
                      </td> 
                      <td> 
                        <input type="text" class="inputscore" name="fr_e" value="<?php echo $FR_E;?>"> 
                      </td>                       
                    </tr>                        
                  </tbody>                   
                </table>                 
