...
<html> 
  <head> 
    <title>PRE SCHOOL | ELIXANDES ACADEMY BRITISH INT' STANDARD</title>     
    <!-- Bootstrap -->     
...
<?php include('header.php');?>
    ...
    <div class="main_bg"> 
      <div class="container-fluid"> 
        <h1 class="crechline">PRE SCHOOL 1-3</h1> 
...
$select=$con->query("select *from student_bio where ENTRY_CLASS='PRE-SCH1' OR ENTRY_CLASS='PRE-SCH2' OR ENTRY_CLASS='PRE-SCH3'");	
}
else if($collectsession=="2018/2019"){
$select=$con->query("select *from student_bio_18 where ENTRY_CLASS='PRE-SCH1' OR ENTRY_CLASS='PRE-SCH2' OR ENTRY_CLASS='PRE-SCH3'");		
}
	if ($select!=false){
