...
<?php include('header.php');?>
    ...
    <div class="main_bg"> 
      <div class="container-fluid"> 
        <h1 class="crechline">BASIC 1-5</h1> 
        <div class="table-responsive holdrecords"> 
          <table class="table table-striped table-bordered table-hover bg-success table-condensed table-responsive" > 
            <thead> 
              <tr> 
                <th>NO.</th> 
                <th>REG NO.</th> 
...
$select=$con->query("select *from student_bio where ENTRY_CLASS='BASIC 1' OR ENTRY_CLASS='BASIC 2' OR ENTRY_CLASS='BASIC 3' OR ENTRY_CLASS='BASIC 4'OR ENTRY_CLASS='BASIC 5'");	
}
else if($collectsession=="2018/2019"){
$select=$con->query("select *from student_bio_18 where ENTRY_CLASS='BASIC 1' OR ENTRY_CLASS='BASIC 2' OR ENTRY_CLASS='BASIC 3' OR ENTRY_CLASS='BASIC 4'OR ENTRY_CLASS='BASIC 5'");		
}
if($select!=false){
...
echo "<tr data-pg-collapsed><td>$x</td><td>$reg</td><td>$surname</td><td>$othername</td><td>$sex</td><td>$dob</td><td>$genotype</td><td>$age</td>
<td>$session</td><td>$parentname</td><td>$mobile</td><td>$nationality</td><td>$class</td><td>$parent_address</td><td>$parentoccupation</td> 
<td>$date</td></tr>";
		}
	}
else{
