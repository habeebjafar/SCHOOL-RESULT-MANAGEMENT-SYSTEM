...
$select=$con->query("select *from student_bio where ENTRY_CLASS='TODDLER'");	
}
else if($collectsession=="2018/2019"){
$select=$con->query("select *from student_bio_18 where ENTRY_CLASS='TODDLER'");		
}
