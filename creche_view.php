      ...
      <div class="container-fluid"> 
        <div class="row header"> 
          <div class="logo navbar-left col-sm-12"> 
            <h1 class=""><a href="index.html" class=""> 
                <div class=""> 
                  <div class="row"> 
                    <div class="col-sm-2"> 
...
<?php include('header.php');?>
    ...
    <div class="main_bg"> 
      <div class="container-fluid"> 
        <h1 class="crechline">CRECHE</h1> 
        <div class="table-responsive holdrecords"> 
          <table class="table table-striped table-bordered bg-success table-condensed"> 
            <thead> 
              <tr> 
                <th>NO.</th> 
                <th>REG NO.</th> 
...
$select=$con->query("select *from student_bio where ENTRY_CLASS='CRECHE'");
}
else if($collectsession=="2018/2019"){
	$select=$con->query("select *from student_bio_18 where ENTRY_CLASS='CRECHE'");
}	
	if ($select!=false){
